...
pub fn main() !void {
    ...
    gl.deleteShader(fragmentShader); // why?
    ...
    gl.bufferData(gl.BufferTarget.element_array_buffer, f32, &indices, gl.BufferUsage.static_draw);
    ...
    // gl.bindBuffer(gl.binding.ELEMENT_ARRAY_BUFFER, 0);
    ...
    // gl.polygonMode(gl.binding.FRONT_AND_BACK, gl.binding.LINE);
